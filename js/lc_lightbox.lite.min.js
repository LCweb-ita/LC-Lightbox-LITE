...
var q=h.elems[h.elem_index].force_over_data;q||(q=400);return p<q||m<q?(b("#lcl_wrap").removeClass("lcl_txt_under_calc").addClass("lcl_force_txt_over"),b("#lcl_subj").css("maxHeight","none"),b("#lcl_txt").css({right:0,width:"auto"}),h.txt_und_sizes="no_under",b(document).trigger("lcl_txt_und_calc"),!0):P(p,m,f,g+1)}b("#lcl_wrap").removeClass("lcl_txt_under_calc");b("#lcl_subj").css("maxHeight",d+l.padding);h.txt_und_sizes={w:c,h:d+m};b(document).trigger("lcl_txt_und_calc");return!0},120)},ca=function(c,
...
b("#lcl_txt").empty();f.elem_index=c;y(!0);K()},l.fading_time)},S=function(c){var d=l;if(!d.progressbar)return!1;c=c?0:d.animation_time+d.fading_time;var f=d.slideshow_time+d.animation_time-c;b("#lcl_progressbar").length||b("#lcl_wrap").append('<div id="lcl_progressbar"></div>');"undefined"!=typeof lcl_pb_timeout&&clearTimeout(lcl_pb_timeout);lcl_pb_timeout=setTimeout(function(){b("#lcl_progressbar").stop(!0).removeAttr("style").css("width",0).animate({width:"100%"},f,"linear",function(){b("#lcl_progressbar").fadeTo(0,
0)})},c)},I=function(){if(!lcl_shown)return!1;"function"==typeof l.on_close&&l.on_close.call({opts:l,vars:h});h.is_arr_instance||(h.elems_selector?b(h.elems_selector):lcl_curr_obj).first().trigger("lcl_on_close");b(document).trigger("lcl_on_close_global");b("#lcl_wrap").removeClass("lcl_shown").addClass("lcl_is_closing lcl_tn_hidden");lcl_stop_slideshow();b(".lcl_fullscreen_mode").length&&T();setTimeout(function(){b("#lcl_wrap, #lcl_inline_style").remove();l.remove_scrollbar&&(jQuery("html").attr("style",
h.html_style),jQuery("body").attr("style",h.body_style));b(document).trigger("lcl_closed_global");lcl_is_active=lcl_shown=lcl_curr_vars=lcl_curr_opts=lcl_curr_obj=!1},l.open_close_time+80);"undefined"!=typeof lcl_size_check&&clearTimeout(lcl_size_check)},F=function(c,d){"undefined"==typeof d&&(d=!1);if(!lcl_shown||!l.fullscreen||!d&&lcl_is_active)return!1;var f=l,e=h;b("#lcl_wrap").addClass("lcl_toggling_fs");f.browser_fs_mode&&"undefined"!=typeof c&&(document.documentElement.requestFullscreen?document.documentElement.requestFullscreen():
document.documentElement.msRequestFullscreen?document.documentElement.msRequestFullscreen():document.documentElement.mozRequestFullScreen?document.documentElement.mozRequestFullScreen():document.documentElement.webkitRequestFullscreen&&document.documentElement.webkitRequestFullscreen(Element.ALLOW_KEYBOARD_INPUT));setTimeout(function(){b("#lcl_wrap").addClass("lcl_fullscreen_mode");x(e.elems[e.elem_index]);b(document).on("lcl_resized_window",function(){b(document).off("lcl_resized_window");(d||"under"==
...
'" data-action="share/whatsapp/share"></a>');e&&(g+='<a class="lcl_icon lcl_pint" onClick="window.open(\'http://pinterest.com/pin/create/button/?url='+c+"&media="+encodeURIComponent(e)+"&description="+f+"','sharer','toolbar=0,status=0,width=575,height=330');\" href=\"javascript: void(0)\"></a>");g+="</div>";b(".lcl_socials").addClass("lcl_socials_shown").html(g);setTimeout(function(){b(".lcl_socials_tt").addClass("lcl_show_tt")},20);if(lcl_curr_opts.fb_direct_share)b(document).off("click",".lcl_fb").on("click",
".lcl_fb",function(b){FB.ui({method:"share_open_graph",action_type:"og.shares",action_properties:JSON.stringify({object:{"og:url":window.location.href,"og:title":d.title,"og:description":d.txt,"og:image":e}})},function(b){window.close()})})}});b(document).on("click",".lcl_fullscreen",function(c){if(k!=lcl_curr_obj)return!0;b(".lcl_fullscreen_mode").length?U(!0):F(!0)});b(document).on("click",".lcl_thumbs_toggle",function(c){if(k!=lcl_curr_obj)return!0;c=b(".lcl_fullscreen_mode").length;b("#lcl_wrap").addClass("lcl_toggling_tn").toggleClass("lcl_tn_hidden");
c||setTimeout(function(){lcl_resize()},160);setTimeout(function(){b("#lcl_wrap").removeClass("lcl_toggling_tn")},lcl_curr_opts.animation_time+50)});w=lcl_on_mobile?" click":"";b(document).on("lcl_tn_elem_click"+w,".lcl_tn_inner > li",function(c){if(k!=lcl_curr_obj)return!0;c=b(this).attr("rel");r(c)});b(document).on("click",".lcl_tn_prev:not(.lcl_tn_disabled_arr)",function(c){if(k!=lcl_curr_obj)return!0;b(".lcl_tn_inner").stop(!0).animate({scrollLeft:b(".lcl_tn_inner").scrollLeft()-lcl_curr_opts.thumbs_w-
>>>>>>> origin/master
