...
b,!1});else if(parseInt(e.elem_index,10)>=e.elems_count)return console.error("LC Lightbox - selected index does not exist"),!1;y(!1);Y();Z();e.force_fullscreen&&F(!0,!0);b("#lcl_thumbs_nav").length&&aa();y(!0);K()},N=function(){b("#lcl_wrap").removeClass("lcl_pre_show").addClass("lcl_shown");b("#lcl_loader").removeClass("lcl_loader_pre_first_el")},Y=function(){var c=l,d=h,f=[],e="";"number"==typeof document.documentMode&&(b("body").addClass("lcl_old_ie"),"outer"!=c.cmd_position&&(c.nav_btn_pos="normal"));
...
lcl_rs_defer=setTimeout(function(){lcl_resize()},50)});var P=function(c,d,f,e){var g="undefined"==typeof e?1:e,k=b(".lcl_fullscreen_mode").length;b("#lcl_txt").outerHeight();var n=c/d;if(k&&b("#lcl_thumbs_nav").length)return b("#lcl_wrap").addClass("lcl_force_txt_over"),b("#lcl_subj").css("maxHeight","none"),b("#lcl_txt").css({right:0,width:"auto"}),h.txt_und_sizes="no_under",b(document).trigger("lcl_txt_und_calc"),!1;b("#lcl_wrap").removeClass("lcl_force_txt_over").addClass("lcl_txt_under_calc");
k?b("#lcl_txt").css({right:0,width:"auto"}):b("#lcl_txt").css({right:"auto",width:c});"undefined"!=typeof lcl_txt_under_calc&&clearInterval(lcl_txt_under_calc);lcl_txt_under_calc=setTimeout(function(){var m=Math.ceil(b("#lcl_txt").outerHeight()),p=d+m-f;if(k)return b("#lcl_wrap").removeClass("lcl_txt_under_calc"),b("#lcl_subj").css("maxHeight",d-m),h.txt_und_sizes={w:c,h:d},b(document).trigger("lcl_txt_und_calc"),!1;if(0<p&&("undefined"==typeof e||10>e)){m=d-p;p=Math.floor(m*n);var q=h.elems[h.elem_index].force_over_data;
q||(q=400);return p<q||m<q?(b("#lcl_wrap").removeClass("lcl_txt_under_calc").addClass("lcl_force_txt_over"),b("#lcl_subj").css("maxHeight","none"),b("#lcl_txt").css({right:0,width:"auto"}),h.txt_und_sizes="no_under",b(document).trigger("lcl_txt_und_calc"),!0):P(p,m,f,g+1)}b("#lcl_wrap").removeClass("lcl_txt_under_calc");b("#lcl_subj").css("maxHeight",d+l.padding);h.txt_und_sizes={w:c,h:d+m};b(document).trigger("lcl_txt_und_calc");return!0},120)},ca=function(c,d,f,e,g){g=b(".lcl_force_txt_over").length;
...
1){if(!e)return!1;c=0}else c=f.elem_index+1;else if("prev"==c)if(f.elem_index)c=f.elem_index-1;else{if(!e)return!1;c=f.elems.length-1}else if(c=parseInt(c,10),0>c||c>=f.elems.length||c==f.elem_index)return!1;"undefined"!=typeof lcl_slideshow&&("undefined"==typeof d||!e&&c==f.elems.length-1)&&lcl_stop_slideshow();lcl_is_active=!0;R(c);y(!1,c,!0);b("#lcl_wrap").addClass("lcl_switching_elem");setTimeout(function(){b("#lcl_wrap").removeClass("lcl_playing_video");"html"==f.elems[f.elem_index].type&&(b("#lcl_window").css("height",
b("#lcl_contents_wrap").outerHeight()),b("#lcl_contents_wrap").css("maxHeight","none"));"function"==typeof l.on_elem_switch&&l.on_elem_switch.call({opts:l,vars:h,new_el:c});!f.is_arr_instance&&lcl_curr_obj&&(f.elems_selector?b(f.elems_selector):lcl_curr_obj).first().trigger("lcl_on_elem_switch",[f.elem_index,c]);b("#lcl_wrap").removeClass("lcl_no_txt lcl_loading_iframe");b("#lcl_txt").empty();f.elem_index=c;y(!0);K()},l.fading_time)},S=function(c){var d=l;if(!d.progressbar)return!1;c=c?0:d.animation_time+
d.fading_time;var f=d.slideshow_time+d.animation_time-c;b("#lcl_progressbar").length||b("#lcl_wrap").append('<div id="lcl_progressbar"></div>');"undefined"!=typeof lcl_pb_timeout&&clearTimeout(lcl_pb_timeout);lcl_pb_timeout=setTimeout(function(){b("#lcl_progressbar").stop(!0).removeAttr("style").css("width",0).animate({width:"100%"},f,"linear",function(){b("#lcl_progressbar").fadeTo(0,0)})},c)},I=function(){if(!lcl_shown)return!1;"function"==typeof l.on_close&&l.on_close.call({opts:l,vars:h});h.is_arr_instance||
...
setTimeout(function(){b("#lcl_wrap").removeClass("lcl_toggling_fs")},150)})},d?f.open_close_time:f.fading_time);"function"==typeof f.on_fs_enter&&f.on_fs_enter.call({opts:f,vars:e});h.is_arr_instance||lcl_curr_obj.first().trigger("lcl_on_fs_enter")},U=function(c){if(!lcl_shown||!l.fullscreen||lcl_is_active)return!1;var d=l;b("#lcl_wrap").addClass("lcl_toggling_fs");b("#lcl_window").fadeTo(70,0);setTimeout(function(){if(d.browser_fs_mode&&"undefined"!=typeof c){T();var f=250}else f=0;b("#lcl_wrap").removeClass("lcl_fullscreen_mode");
setTimeout(function(){x(h.elems[h.elem_index]);var c=c||navigator.userAgent;c=-1<c.indexOf("MSIE ")||-1<c.indexOf("Trident/")?100:0;setTimeout(function(){b("#lcl_window").fadeTo(30,1);b("#lcl_wrap").removeClass("lcl_toggling_fs")},300+c)},f)},70);"function"==typeof d.on_fs_exit&&d.on_fs_exit.call({opts:l,vars:h});h.is_arr_instance||(h.elems_selector?b(h.elems_selector):lcl_curr_obj).first().trigger("lcl_on_fs_exit")},T=function(){document.exitFullscreen?document.exitFullscreen():document.msExitFullscreen?
document.msExitFullscreen():document.mozCancelFullScreen?document.mozCancelFullScreen():document.webkitExitFullscreen&&document.webkitExitFullscreen()},aa=function(){var c=!1,d=!1,f=Date.now();b("#lcl_thumbs_nav").append('<span class="lcl_tn_prev"></span><ul class="lcl_tn_inner"></ul><span class="lcl_tn_next"></span>');b("#lcl_thumbs_nav").attr("rel",f);b.each(h.elems,function(e,g){if("unknown"!=g.type){c||(d&&d!=g.type?c=!0:d=g.type);var k="",n="";tpc="";if(g.thumb)n=g.thumb,k="style=\"background-image: url('"+
g.thumb+"');\"";else{switch(g.type){case "image":n=g.src;break;case "youtube":n=g.poster?g.poster:"https://img.youtube.com/vi/"+g.video_id+"/maxresdefault.jpg";break;case "vimeo":g.poster?n=g.poster:"undefined"==typeof h.vimeo_thumb_cache[g.src]?(tpc="lcl_tn_preload",b.getJSON("https://www.vimeo.com/api/v2/video/"+g.video_id+".json?callback=?",{format:"json"},function(c){V(c[0].thumbnail_large,e,f);h.vimeo_thumb_cache[g.src]=c[0].thumbnail_large;b(".lcl_tn_inner li[rel="+e+"]").attr("style",b(".lcl_tn_inner li[rel="+
...
n+"');\"",-1===b.inArray(g.type,["youtube","vimeo","dailymotion"])||g.poster||(h.elems[e].vid_poster=n))}if(("html"==g.type||"iframe"==g.type)&&!k)return!0;var t="video"!=g.type||k?"":'<video src="'+g.src+'"></video>';tpc="lcl_tn_preload";b(".lcl_tn_inner").append('<li class="lcl_tn_'+g.type+" "+tpc+'" title="'+g.title+'" rel="'+e+'" '+k+">"+t+"</li>");tpc&&V(n,e,f)}});if(2>b(".lcl_tn_inner > li").length)return b("#lcl_thumbs_nav").remove(),!1;b(".lcl_tn_inner > li").css("width",l.thumbs_w);lcl_on_mobile||
b(".lcl_tn_inner").lcl_smoothscroll(.3,400,!1,!0);c&&l.tn_icons&&b(".lcl_tn_inner").addClass("lcl_tn_mixed_types");R(h.elem_index)},V=function(c,d,f){b("<img/>").bind("load",function(){if(!h)return!1;h.img_sizes_cache[c]={w:this.width,h:this.height};b("#lcl_thumbs_nav[rel="+f+"] li[rel="+d+"]").removeClass("lcl_tn_preload");setTimeout(function(){Q();J()},500)}).attr("src",c)},W=function(){var c=0;b(".lcl_tn_inner > li").each(function(){c+=b(this).outerWidth(!0)});return c},Q=function(){if(!b("#lcl_thumbs_nav").length)return!1;
